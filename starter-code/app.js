...
function multiply(a, b) { //eslint-disable-line
  var product = a * b;
  var theString = `The product of ${a} and ${b} is ${product}.`;
  console.log(product, theString);
  return [product, theString];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  var multi = dynamicArray[0];
  for (var i = 1; i < dynamicArray.length; i++) {
    multi = multiply(dynamicArray[i], multi)[0];
    console.log(multi);
  }
  var theString = `The numbers ${dynamicArray} have a product of ${multi}.`;
  return [multi, theString]
}
